...
public class EnchantmentLevelEntryScript extends AbstractExtendablePredicateProvider<Object2IntMap.Entry<Enchantment>> {
    ...
    @Override
    public Predicate<Object2IntMap.Entry<Enchantment>> getLocalPredicate(String in, String val){
        switch (in) {
